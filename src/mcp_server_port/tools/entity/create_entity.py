...
class CreateEntityTool(Tool):
    ...
    def __init__(self, port_client: PortClient):
        super().__init__(
            name="create_entity",
            description="An entity is an instance of a blueprint, it represents the data defined by a blueprint's properties.",
    ...
    async def create_entity(self, props: CreateEntityToolSchema) -> Dict[str, Any]:
        ...
        query = props.query.dict(exclude_unset=True, exclude_none=True) or {}
