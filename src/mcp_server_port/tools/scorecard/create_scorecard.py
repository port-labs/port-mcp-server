...
class CreateScorecardTool(Tool):
    ...
    def __init__(self, port_client: PortClient):
        super().__init__(
            ...
            description="Scorecards enable us to define and track metrics/standards for our Port entities, based on their properties",
    ...
    async def create_scorecard(
        ...
        created_scorecard = await self.port_client.create_new_scorecard(blueprint_identifier, scorecard_data)
