...
class McpServerConfig(BaseModel):
    ...
    mcp_client: str = Field(default="unknown", description="The MCP client name (e.g., vscode, cursor)")
...
def init_server_config(override: dict[str, Any] | None = None):
    ...
    if override is not None:
        config = McpServerConfig(
            ...
            mcp_client=override.get("mcp_client", "unknown"),
        )
        return config
    try:
        ...
        mcp_client = os.environ.get("PORT_MCP_CLIENT", "unknown")
