...
class ActionCommon(BaseModel):
    ...
    invocation_method: ActionInvocationMethod = Field(
        ...,
        description="The invocation method configuration. Must be a JSON object (not a string) with 'type' field and method-specific properties. Supported types: WEBHOOK, GITHUB, GITLAB, AZURE-DEVOPS, KAFKA",
