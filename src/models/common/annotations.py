...
class Annotations(BaseModel):
    ...
    read_only_hint: bool = Field(
        ..., description="If true, indicates the tool does not modify its environment", alias="readOnlyHint",serialization_alias="readOnlyHint"
    )
    ...
    open_world_hint: bool = Field(
        ..., description="If true, the tool may interact with an “open world” of external entities", alias="openWorldHint",serialization_alias="openWorldHint"
    )
