...
class GetEntitiesToolSchema(BaseModel):
    ...
    detailed: bool = Field(default=False, description="If True, returns complete entity details including properties. If False (default), returns summary information only.")
